                    ...
                    <div className="flex-1 flex flex-col lg:grid lg:grid-cols-12 gap-6 overflow-y-auto lg:overflow-visible">
                        <div className="col-span-12 lg:col-span-8 flex flex-col gap-6">
                            ...
                            <div className="card p-6 flex-1 min-h-[300px]">
                                ...
                                <p className="text-[10px] text-white/40 mb-6 uppercase tracking-tighter">Deconstruct a token to see which characters it was merged from.</p>
                        ...
                        <div className="col-span-4 flex flex-col gap-6">
                            <div className="card p-6">
                                <div className="rock-texture"></div>
                                <h3 className="text-xs uppercase tracking-widest text-white/40 mb-1">Efficiency Analytics</h3>
                                <p className="text-[10px] text-white/40 mb-6 uppercase tracking-tighter">How much text length is saved by tokenization.</p>
                                {compressionStats ? (
                            ...
                            <div className="card flex-1 p-6 flex flex-col overflow-hidden">
                                <div className="rock-texture"></div>
                                <h3 className="text-xs uppercase tracking-widest text-white/40 mb-1">Token Strata</h3>
                                <p className="text-[10px] text-white/40 mb-6 uppercase tracking-tighter">The "geological" depth of each token based on its merge age.</p>
